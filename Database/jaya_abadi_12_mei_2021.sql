...
('B4127279', 'PAKU', 'K624024', 'M34031', '1CM', 'S95335', 'S74773', 200, 100, -443, 0),
('B9343685', 'GELAS', 'K624024', 'M34031', 'KECIL', 'S95335', 'S95335', 5000, 2000, 4050, 0);
...
CREATE TABLE `order` (
  ...
  `pembelian_supplier_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `order_customer_id` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `order_sales_id` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
INSERT INTO `order` (`pembelian_id`, `pembelian_supplier_id`, `order_customer_id`, `order_sales_id`, `order_type`, `pembelian_tanggal`, `pembelian_tanggal_jatuh_tempo`, `pembelian_faktur`, `pembelian_pajak`, `pembelian_diskon`, `pembelian_total`, `pembelian_status`) VALUES
('INV131384', '', 'PEL6424533', 'USR96941', 200, '2021-05-12', '2021-05-12', '0', 0, 0, 50000, 'ST200'),
('INV475807', 'SUP3395801', '', '', 100, '2021-05-12', '2021-05-13', '0', 0, 0, 100000, 'ST200');
...
(1223, 'INV475807', 'B9343685', 'S95335', 50, 2000, 100000),
(1224, 'INV131384', 'B4127279', 'S95335', 500, 100, 50000);
...
('USR79145', 'JOHNDOE', 2001, 1),
('USR96941', 'JANE DOE', 3001, 1);
...
INSERT INTO `transaksi` (`transaksi_id`, `order_id`, `transaksi_jumlah`) VALUES
('TRC279687', 'INV131384', '50000'),
('TRC388638', 'INV188129', '100000'),
('TRC408219', 'INV349684', '60000'),
('TRC497641', 'INV475807', '100000'),
('TRC544493', 'INV245797', '4500'),
('TRC645421', 'INV637003', '40000'),
('TRC803000', 'INV161849', '200000');
...
--
ALTER TABLE `order_item`
  MODIFY `pembelian_item_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1225;
